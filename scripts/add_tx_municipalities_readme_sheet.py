...
def build_rows(wb):
    ...
    glossary = wb["Special District Key Glossary"]
    n_glossary = count_data_rows(glossary, 5)

    return [
        ("Special District Key Glossary",
         "Summary of the ocd-division/ocd-jurisdiction type-key registry for TX special-district entities "
         "that don't map 1:1 onto an existing county/place jurisdiction (issue #32), parsed live from "
         "reference/TX Rolling Audit/Special_District_Type_Keys.md -- that document is the source of truth; "
         "this sheet is a snapshot, regenerated by scripts/add_tx_special_district_glossary_sheet.py.",
         f"{n_glossary} type keys registered."),
