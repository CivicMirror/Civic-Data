...
- **Montgomery — resolved 2026-09-19** (issue #70 comment thread, DeGregorio's email reply): seats corrected 1→2, matching the agreement. Erik Morrissey won the second seat in 2024 but never took office (resigned around when he left the Select Board in 2025), leaving it vacant until Jakob Wyman won it in 2026 (3-yr term, end 2029, minted). DeGregorio's own 2024 win dated to a 3-yr term (end 2027). Morrissey not minted -- never served.
...
## Royalston / Athol-Royalston Regional
- Post: `royalston-ma/athol-royalston-regional-school-committee-member`, 0/3 -- unresolved.
- **2026-09-18 findings**: the old Duquette dispute is resolved -- a 2022 Royalston ATE results PDF (gardnermagazine.com) shows the ballot ran two *separate* town-specific races, "Athol Royalston Regional School Committee (ROYALSTON)" and "...(ATHOL)". Tammy Duquette won the **ATHOL** line (101 votes), not Royalston's; Royalston's 2022 winner was Brittany M. Newton (133 votes). Duquette is correctly on file as an Athol member, not a Royalston one.
- Still unresolved: no current (2026) Royalston-specific election result found to confirm who holds the 3 seats now, beyond the already-known complication that 2026 winner Kiley Hall resigned weeks after election. User has emailed the Royalston town clerk (2026-09-18) for the current roster -- **on hold, wait for that reply** before minting anything for this post.

## Frontier Regional (Conway, Deerfield, Sunderland, Whately)
- Regional agreement (policy BB-1, user-supplied): 11-member committee -- 4 Deerfield (3 elected + 1 appointed), 3 Sunderland (2 elected + 1 appointed), 2 Whately (1 elected + 1 appointed), 2 Conway (1 elected + 1 appointed). Appointed seats are filled annually by each town's own local School Committee from its own membership.
- District's own (untownlabeled) 11-member roster, user-supplied from frsu38.org: Novak (Chair), Leone (Vice Chair), Corwin (Secretary), Halla, Smith, Kantor, Ramon, Dean, Fosnot, Curtis, Van Driesche.
- **Applied 2026-09-18, all 7 elected seats now filled**: Deerfield 3/3 (Leone 2024, Fosnot 2025-998votes, Novak 2026-727votes/Chair) via deerfieldma.us ATE PDFs. Sunderland 2/2 (Curtis 2025-unopposed, Dean 2026-516votes) via townofsunderland.us ATE PDFs. Conway 1/1 (Van Driesche) already on file. Whately 1/1 (William Smith, 2024-06-11 ATE .docx, 285 votes, in a race distinct from Whately's own local School Committee line) -- see below for the unresolved 2026 wrinkle.
- **Whately local School Committee also fixed/filled 2026-09-18**: seats corrected 4 → 3 (town's own board-terms page self-reports "Active Members: 3, Vacant Terms: 0"); filled Robert Halla (Chair, elected), David Theoharides (Vice Chair, elected, 2026 ATE 132 votes), Henry Frechette (Clerk, appointed by Selectboard).
- **Still open**: the 4 appointed seats (1 per town) are not modeled anywhere. Lead, not confirmed: "Mary Ramon" on the master roster matches Deerfield's own local School Committee member Mary A. Ramon. Also unresolved: Whately's 2026-04-28 ATE shows a second, distinct "SCHOOL COMMITTEE - 3 YEAR" race with "FAILURE TO ELECT" -- inconsistent with William Smith's 2024-elected term not being up again until 2027, so it's unclear what that race actually was. Left unresolved rather than guessed.
- Sunderland's own local Elementary School Committee also partially filled as a bonus find: 2/5 (Joseph W. Elias, Amanda Elizabeth Wygant, both from the 2026 ATE) -- 3 seats still need earlier-year results.
